...
(This example was burrowed from [Type-Driven Development with Idris](https://www.manning.com/books/type-driven-development-with-idris).)
...
However, we are also able to write:
...
public abstract class DoorState {
  public static final class DoorClosed extends DoorState {}
  public static final class DoorOpen extends DoorState {}
}
...
We adjust our program's type, stating that the program begins with a _closed_ door and also _ends with a closed door_:
