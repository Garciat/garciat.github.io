...
How? Java supports [closures](https://en.wikipedia.org/wiki/Closure_(computer_programming)) in inner classes. That means that the parameters of `Credentials::basic` are automatically and implicitly captured by the anonoymous inner classes inside for its use.
...
If you actually read this far and _do_ find this interesting: I used it to implement [a functional applicative parser](https://gist.github.com/Garciat/c334cdef1abef57a33272b8787496b1a) (with a working `BigInteger` parser implementation).
